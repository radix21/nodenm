            ...
            template:  ['<div layout="column" class="lf-ng-md-file-input" ng-model="'+genLfObjId()+'">',
                            ...
                            '<div layout="row" class="lf-ng-md-file-input-container" >',
                                ...
                                '<md-button ng-if="disabledRemove" ng-disabled="isDisabled" ng-click="removeAllFiles()" ng-hide="isFilesNull" class="md-raised lf-ng-md-file-input-button lf-ng-md-file-input-button-remove" >',
                                    ...
                                    '{{strCaptionRemove}}',
                                '</md-button>',
                                '<md-button ng-disabled="isDisabled" ng-click="openDialog($event, this)" class="md-raised md-accent lf-ng-md-file-input-button lf-ng-md-file-input-button-brower" >',
